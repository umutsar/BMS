...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  arduinoTransmit[47] = receivedData[128];

	  // MAX V POSITION
	  arduinoTransmit[48] = receivedData[130];
	  // MIN V POSITION
	  arduinoTransmit[49] = receivedData[134];

	  // DIFFERANTIE PRESSURE
	  arduinoTransmit[50] = receivedData[136];

	  // TEMPS (SICAKLIKLAR)
	  arduinoTransmit[51] = receivedData[100];
	  arduinoTransmit[52] = receivedData[102];
	  arduinoTransmit[53] = receivedData[104];
	  arduinoTransmit[54] = receivedData[106];

	  // MAX TEMP
	  arduinoTransmit[55] = receivedData[108];
	  arduinoTransmit[56] = receivedData[138];

	  // MIN TEMP
	  arduinoTransmit[57] = receivedData[110];
	  arduinoTransmit[58] = receivedData[142];

	  // MEAN TEMP
	  arduinoTransmit[59] = receivedData[112];
